...
// $fc = new createEsriPHP();
// $tkn = 'ldsLQFGSolAyebcGU26BYrTdmWvRd78EJFAQ9RNO7CMoBGO9G5yWsYPQceoAey41agJj0EiJ-21JUV2_WkPsa6_wFt9896R1JKpTsZkCm6DP3hBoPSfnJ7ZjEUvV9Uoa8UO--FTOxjUhc1iWhyL1tptAWatayW4X7tINzoZDbwfsy2XPeXMI2aSp3vEKTo3y5OmkVn5TLmR0IIPkQH66Qk5M3QOB8MbEeMonRBH8Pe4.';
// $layer = 'https://sigi.pu.go.id/portalpupr/rest/services/Hosted/V_P_Aset_4/FeatureServer/0';
// $res = $fc->editvector($tkn,$layer,array(
//   "attributes"=>array("fid"=>4229,"keyaset"=>6514,"keybalai"=>1,"keyws"=>17)
// ));
//$layer = 'https://sigi.pu.go.id/portalpupr/rest/services/Hosted/featuredummy/FeatureServer/0';
// $res = $fc->createvector($tkn,$layer,'field_int',array(array(
//   "geometry"=>array("x"=>100,"y"=>100),
//   "attributes"=>array("field_int"=>99,"field_text"=>"xxx")
// )));
// $res = $fc->createvector($tkn,$layer,'field_int',array(
//   array(
//     "geometry"=>array("x"=>200,"y"=>200),
//     "attributes"=>array("field_int"=>103,"field_text"=>"QQQ")
//   ),
//   array(
//     "geometry"=>array("x"=>200,"y"=>200),
//     "attributes"=>array("field_int"=>105,"field_text"=>"ZZZ")
//   )
// ));
// $res = $fc->createvector($tkn,$layer,'field_int',
//   array(
//     "geometry"=>array("x"=>200,"y"=>200),
//     "attributes"=>array("field_int"=>106,"field_text"=>"CCC")
//   )
// );
// $res = $fc->createvector($tkn,$layer,'field_int',
//   array(
//     "geometry"=>array("x"=>200,"y"=>200),
//     "attributes"=>array("field_int"=>103,"field_text"=>"CCC")
//   )
// );

//$res = $fc->inDatabase($tkn,$layer,'field_int',array(97,98));
// $res = $fc->deletevector($tkn,$layer,'keyaset',array(6101,6102,6103,6104,6105,6106,6107,6108,6109,6110,6111,6112,6113,6114,6115,6116,6117,6118,6119,6120,6121,6122,6123,6124,6125,6126,6127,6128,6129,6130,6131,6132,6133,6134,6135,6136,6137,6138,6139,6140,6141,6142,6143,6144,6145,6146,6148));
// $res = $fc->deletevector($tkn,$layer,'field_int',106);
// $res = $fc->editvector($tkn,$layer,'field_int',array(
//   array(
//     "attributes"=>array("field_int"=>100,"field_text"=>'QQQ')
//   ),
//   array(
//     "attributes"=>array("field_int"=>101,"field_text"=>'QQQ')
//   )
// ));
// $res = $fc->editvector($tkn,$layer,'field_int',
//   array(
//     "attributes"=>array("field_int"=>101,"field_text"=>'QZX')
//   )
// );
// $res = $fc->editvector($tkn,$layer,'field_int',
//   array(
//     "attributes"=>array("field_int"=>97,"field_text"=>'zzz')
//   ));
//$res = $fc->getField($tkn,$layer,true);
//$res = $fc->inRadius($tkn,$layer,array("x"=>2,"y"=>2),200,true);
// $res = $fc->identify($tkn,array(
//   'https://sigi.pu.go.id/portalpupr/rest/services/Hosted/featuredummy/FeatureServer/0'
// ),array("x"=>2,"y"=>2),100,true);
// $res = $fc->readData($tkn,'https://sigi.pu.go.id/portalpupr/rest/services/Hosted/V_G_WS/FeatureServer/0',"keybalai=1",array("returnExtentOnly"=>"true"));
// $geom = "{x:106.78094448674591,y:-6.177868846478245}";
// $geom = array("x"=>106.78094448674591,"y"=>-6.177868846478245);
// $res = $fc->inRadius($tkn,$layer,$geom,1000,false);
